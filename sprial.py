...
class SpiralFunctionExample(LinearODEF):
    def __init__(self):
        super(SpiralFunctionExample, self).__init__(Tensor([[-0.1, -1.], 
                                                            [1., -0.1]]))
...
conduct_experiment(ode_true, ode_trained, 400, "linear")
...
conduct_experiment(ode_true, ode_trained, 400, "comp", plot_freq=30)
