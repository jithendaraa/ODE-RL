...
convgru_encoder_params = [
    ...
    [
        CGRU_cell(shape=(32,32), input_channels=16, filter_size=5, num_features=32),
...
convgru_decoder_params = [
    [
        OrderedDict({'deconv1_leaky_1': [32, 1, 4, 2, 1]}),
        # OrderedDict({'deconv2_leaky_1': [96, 96, 4, 2, 1]}),
        # OrderedDict({
            # 'conv3_leaky_1': [64, 16, 3, 1, 1],
            # 'conv4_leaky_1': [16, 1, 1, 1, 0]
    ...
    [
        CGRU_cell(shape=(32,32), input_channels=32, filter_size=5, num_features=32),
