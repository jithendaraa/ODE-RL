...
class VisualObservationModel(jit.ScriptModule):
  __constants__ = ['embedding_size', 'phyre_env']
  
  def __init__(self, belief_size, state_size, embedding_size, activation_function='relu', phyre_env=False):
    super().__init__()
    self.act_fn = getattr(F, activation_function)
    self.embedding_size = embedding_size
    self.phyre_env = phyre_env
...
def ObservationModel(symbolic, observation_size, belief_size, state_size, embedding_size, activation_function='relu', phyre_env=False):
  if symbolic:
    return SymbolicObservationModel(observation_size, belief_size, state_size, embedding_size, activation_function)
  else:
    return VisualObservationModel(belief_size, state_size, embedding_size, activation_function, phyre_env=phyre_env)
...
class VisualEncoder(jit.ScriptModule):
  ...
  def __init__(self, embedding_size, activation_function='relu', phyre_env=False):
    super().__init__()
    self.act_fn = getattr(F, activation_function)
    self.phyre_env = phyre_env
    self.embedding_size = embedding_size
...
def Encoder(symbolic, observation_size, embedding_size, activation_function='relu', phyre_env=False):
  if symbolic:
    return SymbolicEncoder(observation_size, embedding_size, activation_function)
  else:
    return VisualEncoder(embedding_size, activation_function, phyre_env=phyre_env)
