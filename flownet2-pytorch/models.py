...
sys.path.append('./networks/channelnorm_package')
sys.path.append('./networks/correlation_package')
sys.path.append('./networks/resample2d_package')
...
try:
    ...
    print("ChannelNorm imported!")
    from networks.resample2d_package.resample2d import Resample2d
    print("Resample2d imported!")
    from networks import FlowNetC
    print("FlowNetC imported")
    from networks import FlowNetS
    print("FlowNetS imported")
    from networks import FlowNetSD
    print("FlowNetSD imported")
    from networks import FlowNetFusion
    print("FlowNetFusion imported")
