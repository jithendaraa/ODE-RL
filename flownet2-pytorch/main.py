...
if __name__ == '__main__':
    ...
    parser.add_argument('--crop_size', type=int, nargs='+', default = [64, 64], help="Spatial dimension to crop training samples for training")
    ...
    with tools.TimerBlock("Building {} model".format(args.model)) as block:
        ...
        if args.resume and os.path.isfile(args.resume):
            ...
            print("loaded model checkpoint at", args.resume)
    ...
    for epoch in progress:
        ...
        last_epoch_time = progress._time()
        end_time = time.time()
        print("Time for epoch", epoch, ":", end_time - start_time, "s")
